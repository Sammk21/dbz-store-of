    ...
    <>
      ...
      >
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <div className="bg-black text-white flex flex-col gap-y-3 justify-center items-center text-large-regular p-4 h-full w-full  border-gray-200 border-t-[0.3px]">
